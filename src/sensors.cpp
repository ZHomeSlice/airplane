...
//                    Adafruit_BMP280::STANDBY_MS_1); /* Standby time. */
    ...
    /* MPU6050 */
    //mpu.Set_DMP_Output_Rate(DMP_10Hz); <<< get the latest version and this is no longer used as it is dificult to manage and the new code allows you to pick any rate from 200Hz to 5Minutes
